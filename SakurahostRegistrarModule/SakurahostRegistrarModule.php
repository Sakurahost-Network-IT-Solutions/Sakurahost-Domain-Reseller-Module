...
use ModulesGarden\DomainsReseller\Registrar\SakurahostRegistrarModule\Calls;
use ModulesGarden\DomainsReseller\Registrar\SakurahostRegistrarModule\Core\Configuration;

//Loader
include_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR . "Loader.php";
new \ModulesGarden\DomainsReseller\Registrar\SakurahostRegistrarModule\Core\Loader(__DIR__);
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_getConfigArray()
{
    $configarray = [
        "FriendlyName" => [
            "Type"  => "System",
            "Value" => "Sakurahost Registrar Module"
        ],
        "Description"  => [
            "Type"  => "System",
            "Value" => "Resell a piece of the Tanzanian internet with a custom.TZ domain name! Sakurahost&#039;s dedicated.TZ Domain Registration Module makes it quick and easy for individuals and businesses to register their perfect domain name, directly from Tanzania&#039;s leading web hosting provider."
        ],
        "Username"     => [
        ...
        "ApiEndpoint"  => [
            ...
            "Default"      => "https://sakurahost.co.tz/modules/addons/DomainsReseller/api/index.php"
        ],
    ];
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_RegisterDomain($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_TransferDomain($params)
{
    $postfields =
        [
            "domain"       => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_RenewDomain($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_GetNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_SaveNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_ReleaseDomain($params)
{
    $postfields =
        [
            "domain"      => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_GetEPPCode($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_GetContactDetails($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_SaveContactDetails($params)
{
    $postfields =
        [
            "domain"         => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_GetRegistrarLock($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_SaveRegistrarLock($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_GetDNS($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_SaveDNS($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_RegisterNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_ModifyNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_DeleteNameserver($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_RequestDelete($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_TransferSync($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_Sync($params)
{
    $postfields =
        [
            "domain" => "{$params["sld"]}.{$params["tld"]}"
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_GetEmailForwarding($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_SaveEmailForwarding($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function SakurahostRegistrarModule_IDProtectionToggle($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array
 */
function SakurahostRegistrarModule_IDProtectToggle($params)
{
    return SakurahostRegistrarModule_IDProtectionToggle($params);
}
 ...
 */
function SakurahostRegistrarModule_CheckAvailability($params)
{
    $postfields =
        [
